            ...
            update={
                "proveedor_datos": self.reglas.proveedor_datos.model_copy(
                    update={
                        ...
                        "divisas": None,
                        "sectores": None,
                        # Sin esto, `--proveedor sintetico` seguia pidiendo los
                        # fundamentales de EE. UU. a la SEC y los de Brasil a la
                        # CVM, por la red (riesgo RT-6 de docs/PROJECT_PLAN.md).
