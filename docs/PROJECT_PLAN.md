...
|---|---|---|---|
| RD-1 | **yfinance no es una fuente comercializable, y ya no tiene respaldo.** Es un scraper no oficial de Yahoo; sus condiciones no permiten redistribuir los datos en un producto de pago, no hay SLA y puede romperse cualquier día. La mitigación prevista era Stooq, que al verificarla (16/09/2026) resultó tener un desafío anti-bot: **no existe alternativa hoy**. | Bloquea la monetización **y deja los precios de los cinco mercados colgando de una única fuente sin SLA** | Desarrollar con ella; **antes de cobrar**, migrar a proveedor con licencia comercial. Y buscar un respaldo de precios real, que pasó de «previsto» a pendiente. Ver DATA_SOURCES.md. |
